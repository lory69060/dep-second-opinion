...
| 12 | same | [#11](https://github.com/lory69060/dep-second-opinion-trial/pull/11) | dependabot / bump debug minor | REVIEW_RECOMMENDED | REVIEW | ok | Y | Y | **真实 Dependabot**；prod minor；**已合** 2026-08-27；合前读 REVIEW 评论后合入；**操作者代填** | 2026-08-27 |
